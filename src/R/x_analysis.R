...
grid <- expand_grid(
  T_air = seq(14, 20, length.out = 300),  # Air temperature range (°C)
...
p_marg <- ggplot() +
  ...
  coord_cartesian(xlim = c(14, 20), expand = FALSE) +
...
write_csv(analysis_wide, here::here("data", "02-export","Ankle_Draft2_survey_analysis_data.csv"))
